...
import rendering.BackgroundRenderer;
 ...
 * Images</a>.
 */
public class TestArucoActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
    private static final String TAG = TestArucoActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_aruco);
    ...
    private boolean setupAugmentedImageDatabase(Config config) {
        ...
        try (InputStream is = getAssets().open("newimagedb.imgdb")) {
    ...
    private Bitmap loadAugmentedImageBitmap() {
        try (InputStream is = getAssets().open("arucotwo.jpg")) {
