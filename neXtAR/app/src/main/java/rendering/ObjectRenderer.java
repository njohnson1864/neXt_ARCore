...
public class ObjectRenderer {
  ...
  //trying to saved the indexed obj file from opengl to read through
  private static final String filepath="C:\\Users\\testimages";
  // Shader names.
...
//    objectOut.close();
   ...
   * @param scaleFactorX A separate scaling factor to apply before the {@code modelMatrix}.
   * @see Matrix
   */
