...
public class PointCloudRenderer {
  ...
  public void createOnGlThread(Context context) throws IOException {
    rendering.ShaderUtil.checkGLError(TAG, "before create");
    ...
    rendering.ShaderUtil.checkGLError(TAG, "buffer alloc");

    int vertexShader =
        rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER, VERTEX_SHADER_NAME);
    int passthroughShader =
        rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_FRAGMENT_SHADER, FRAGMENT_SHADER_NAME);
    ...
    rendering.ShaderUtil.checkGLError(TAG, "program");
    ...
    rendering.ShaderUtil.checkGLError(TAG, "program  params");
  }
  ...
  public void update(PointCloud cloud) {
    ...
    rendering.ShaderUtil.checkGLError(TAG, "before update");
    ...
    rendering.ShaderUtil.checkGLError(TAG, "after update");
  }
  ...
  public void draw(float[] cameraView, float[] cameraPerspective) {
    ...
    rendering.ShaderUtil.checkGLError(TAG, "Before draw");
    ...
    rendering.ShaderUtil.checkGLError(TAG, "Draw");
  }
}
